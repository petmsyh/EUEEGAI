...
# --- Streamlit UI ---
st.title("Ethiopian Entrance Exam QA Generative AI")
st.write("Ask any EUEE question or enter a topic.")
...
if query:
    ...
    # --- Subject filtering ---
    # List of supported subjects (add more as needed)
    ...
    if subject_in_query:
        # Filter results by subject in source
        filtered_results = [
            r for r in results
    ...
    if not filtered_results:
        st.markdown("I don't have any questions related to this query.")
    else:
